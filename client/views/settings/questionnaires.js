questionnairesPaginator = new Paginator(questionnaires, 10);
questionsPaginator = new Paginator(questions, 10);

Template.questionnaires.helpers({
  questionnairesPaginator: function(){
    return questionnairesPaginator;
  },
  questionnaires: function () {
    return questionnairesPaginator.pagedItems();
  },
...
Template.questionnaires.events({
  ...
  "submit #new-questionnaire-form": function (e, t) {
    ...
    var newQuestionnnaire = new Questionnaire(questionnaireDoc);
...
Template.questionnaireQuestions.helpers({
  ...
  questionsPaginator: function () {
    return questionsPaginator;
  },
  "questionnaireQuestions": function () {
    return questionsPaginator.pagedItems({questionnaireId: Session.get("selectedQuestionnaireId")}, {orderNumber: 1});
  },
